...
#It is up to you to figure out the calculation for an accurate BMI reading and trying it to
#the right classification

#Code Here:

W = float(input("type in your weight kg : "))
H = float(input("type in your Height meters  : "))
